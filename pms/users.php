            ...
            <form method="post" enctype="multipart/form-data">
             <div class="row">
              ...
              <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                ...
                name="save_user" class="btn btn-primary btn-sm btn-flat btn-block">اضافة</button>
              </div>
            </div>
          </form>
        </div>
         ...
         <div class="row table-responsive">
          ...
          <thead>
            <tr>
             ...
             <th class="p-1 text-center">الصورة</th>
      ...
      if(userName !== '') {
        $.ajax({
          ...
          success: function (count, status, xhr) {
            if(count > 0) {
              showCustomMessage("اسم المستخدم هذا موجود. يرجى اختيار اسم مستخدم آخر");
