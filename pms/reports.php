    ...
    <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">زيارات المرضئ بتاريخ محدد</h3>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <?php 
            echo getDateTextBox('من', 'patients_from');

            echo getDateTextBox('الى', 'patients_to');
            ?>
          
          <div class="col-md-2">
            <label>&nbsp;</label>
            <button type="button" id="print_visits" class="btn btn-primary btn-sm btn-flat btn-block">انشاء ملف</button>
          </div>
          </div>
        </div>
        <!-- /.card-body -->
...
<div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">تقرير عن مرض بتاريخ معين</h3>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <?php 
            echo getDateTextBox('من', 'disease_from');

            echo getDateTextBox('الى', 'disease_to');
            ?>
          
          <div class="col-md-2">
            <label>&nbsp;</label>
            <button type="button" id="print_diseases" class="btn btn-primary btn-sm btn-flat btn-block">انشاء ملف</button>
          </div>
          </div>
        </div>
        <!-- /.card-body -->
    ...
    $("#print_visits").click(function() {
      ...
      if(from !== '' && to !== '') {
        ...
        if(win) {
          ...
          showCustomMessage('يرجى السماح بالنوافذ المنبثقة.');
        }
      }
    });
