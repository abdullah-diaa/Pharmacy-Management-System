    ...
    <section class="content">
     ...
     <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">تحديث بيانات االمرضئ</h3>
          ...
          <form method="post">
            ...
            <div class="row">
              ...
              <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                ...
                name="save_Patient" class="btn btn-primary btn-sm btn-flat btn-block">تحديث</button>
              </div>
            </div>
          </form>
        </div>
