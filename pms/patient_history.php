    ...
    <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">ابحث عن  تقارير المرضئ</h3>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12">
              ...
              class="btn btn-primary btn-sm btn-flat btn-block">بحث</button>
            </div>
            </div>
                ...
                <table id="patient_history" class="table table-striped table-bordered">
                  ...
                  <thead>
                    <tr class="bg-gradient-primary text-light">
                      <th class="p-1 text-center">التسلسل</th>
                      <th class="p-1 text-center">تاريخ المراجعة</th>
                      <th class="p-1 text-center">الامراض</th>
                      <th class="p-1 text-center">العلاج</th>
                      <th class="p-1 text-center">الحجم/م</th>
                      <th class="p-1 text-center">الكمية</th>
                      <th class="p-1 text-center">الجرعات اليومية</th>
                    </tr>
                  </thead>
